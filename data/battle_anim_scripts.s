...
Move_SECRET_POWER:
	...
	jumpargeq 0, BATTLE_TERRAIN_GRASS_DAY,           Move_NEEDLE_ARM
	jumpargeq 0, BATTLE_TERRAIN_GRASS_TWILIGHT,      Move_NEEDLE_ARM
	jumpargeq 0, BATTLE_TERRAIN_GRASS_NIGHT,         Move_NEEDLE_ARM
	jumpargeq 0, BATTLE_TERRAIN_LONG_GRASS_DAY, 	 Move_MAGICAL_LEAF
	jumpargeq 0, BATTLE_TERRAIN_LONG_GRASS_TWILIGHT, Move_MAGICAL_LEAF
	jumpargeq 0, BATTLE_TERRAIN_LONG_GRASS_NIGHT  ,  Move_MAGICAL_LEAF
	jumpargeq 0, BATTLE_TERRAIN_SAND_DAY,            Move_MUD_SHOT
	jumpargeq 0, BATTLE_TERRAIN_SAND_TWILIGHT,       Move_MUD_SHOT
	jumpargeq 0, BATTLE_TERRAIN_SAND_NIGHT,          Move_MUD_SHOT
	jumpargeq 0, BATTLE_TERRAIN_UNDERWATER,          Move_WATERFALL
	jumpargeq 0, BATTLE_TERRAIN_WATER_DAY,           Move_SURF
	jumpargeq 0, BATTLE_TERRAIN_WATER_TWILIGHT,      Move_SURF
	jumpargeq 0, BATTLE_TERRAIN_WATER_NIGHT,         Move_SURF
	jumpargeq 0, BATTLE_TERRAIN_POND_DAY,            Move_BUBBLE_BEAM
	jumpargeq 0, BATTLE_TERRAIN_POND_TWILIGHT,       Move_BUBBLE_BEAM
	jumpargeq 0, BATTLE_TERRAIN_POND_NIGHT,          Move_BUBBLE_BEAM
	jumpargeq 0, BATTLE_TERRAIN_MOUNTAIN_DAY,        Move_ROCK_THROW
	jumpargeq 0, BATTLE_TERRAIN_MOUNTAIN_TWILIGHT,   Move_ROCK_THROW
	jumpargeq 0, BATTLE_TERRAIN_MOUNTAIN_NIGHT,      Move_ROCK_THROW
	jumpargeq 0, BATTLE_TERRAIN_CAVE,                Move_BITE
	jumpargeq 0, BATTLE_TERRAIN_CAVE_WATER,          Move_WATERFALL
	jumpargeq 0, BATTLE_TERRAIN_BUILDING_DAY,        Move_STRENGTH
	jumpargeq 0, BATTLE_TERRAIN_BUILDING_TWILIGHT,   Move_STRENGTH
	jumpargeq 0, BATTLE_TERRAIN_BUILDING_NIGHT,      Move_STRENGTH
	jumpargeq 0, BATTLE_TERRAIN_AUTUMN_DAY,          Move_SMOKESCREEN
	jumpargeq 0, BATTLE_TERRAIN_AUTUMN_TWILIGHT,     Move_SMOKESCREEN
	jumpargeq 0, BATTLE_TERRAIN_AUTUMN_NIGHT,        Move_SMOKESCREEN
	jumpargeq 0, BATTLE_TERRAIN_BEACH_DAY,           Move_SAND_ATTACK
	jumpargeq 0, BATTLE_TERRAIN_BEACH_TWILIGHT,      Move_SAND_ATTACK
	jumpargeq 0, BATTLE_TERRAIN_BEACH_NIGHT,         Move_SAND_ATTACK
	jumpargeq 0, BATTLE_TERRAIN_CHIMNEY_DAY,         Move_FLAMETHROWER
	jumpargeq 0, BATTLE_TERRAIN_CHIMNEY_TWILIGHT,    Move_FLAMETHROWER
	jumpargeq 0, BATTLE_TERRAIN_CHIMNEY_NIGHT,       Move_FLAMETHROWER
	goto Move_SLAM
